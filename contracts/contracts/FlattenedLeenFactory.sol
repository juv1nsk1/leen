...
contract LeenPool is Ownable, ReentrancyGuard, Pausable {
    ...
    function borrow(uint256 amount) external nonReentrant whenNotPaused {
        ...
        config.token.safeTransferFrom(msg.sender, address(this), requiredCollateral);
    ...
    function withdraw(uint256 amount) external nonReentrant whenNotPaused {
        ...
        uint256 minRequired = (borrowed[msg.sender] * config.collateralRatio) / 100;
    ...
    function getUserInfo(address user) external view returns (uint256 deposited, uint256 debt) {
    ...
    event Liquidated(address indexed user, address indexed liquidator, uint256 seized, uint256 penalty);
}


// File contracts/LeenFactory.sol
